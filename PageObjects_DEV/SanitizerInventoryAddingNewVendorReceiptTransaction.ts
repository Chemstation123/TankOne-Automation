import { Page, expect } from "@playwright/test";
    ...
    export class SanitizerInventoryAddingNewVendorReceiptTransaction {
        public page : Page;
    ...
    async performAddingNewVendorReceiptTransaction()
    {
        ...
        console.log(`Generated LOT Number: ${randomLOT}`);

        // Transaction Code
        await this.page.getByPlaceholder('Select a transaction code').click();
        await this.page.getByText('VendorReceipt').click();
        ...
        // Verify values
        await expect(this.page.getByRole('gridcell', { name: 'VendorReceipt' })).toBeVisible();
