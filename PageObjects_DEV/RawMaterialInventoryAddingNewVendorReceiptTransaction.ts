...
import { AddingVendorReceiptRawMaterialInventory } from "../TestData_Dev/RawMaterialInventoryVendorReceiptAddingJData";



    export class RawMaterialInventoryAddingNewVendorReceiptTransaction {
        public page : Page;
        ...
        async performAddingNewVendorReceiptTransaction()
        {
          ...
          await this.page.getByLabel('Lot Number: *').fill(AddingVendorReceiptRawMaterialInventory.LOTNUmber);
          console.log(AddingVendorReceiptRawMaterialInventory.LOTNUmber);

          //Selecting Transaction type
          await this.page.getByPlaceholder('Select a transaction code').click();
          await this.page.getByText(AddingVendorReceiptRawMaterialInventory.TransactionCode).click();
          console.log(AddingVendorReceiptRawMaterialInventory.TransactionCode);

          //Selecting Unit of issue 
          await this.page.getByPlaceholder('Select a unit of issue').click();
          await this.page.getByLabel('Items').getByText(AddingVendorReceiptRawMaterialInventory.UnitOfIssueID).click();
          console.log(AddingVendorReceiptRawMaterialInventory.UnitOfIssueID)
          ...
          await this.page.getByLabel('Operator Name:').fill(AddingVendorReceiptRawMaterialInventory.OperatorName);
          await this.page.getByLabel('Keyed By:').click();
          await this.page.getByLabel('Keyed By:').fill(AddingVendorReceiptRawMaterialInventory.KeyedBy);
          await this.page.getByLabel('Note:').click();
          await this.page.getByLabel('Note:').fill(AddingVendorReceiptRawMaterialInventory.Note);
          ...
          await this.page.screenshot({ path: `Screenshots_DEV/4(VendorReceipt).png`});
