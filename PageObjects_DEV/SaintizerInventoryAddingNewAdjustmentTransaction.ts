import { Page, expect } from "@playwright/test";
    ...
    export class SanitizerInventoryAddingNewAdjustmentTransaction {
        public page : Page;
    ...
    async performAddingNewAdjustmentTransaction()
    {
        ...
        await this.page.getByText('Adjustment').click();
        ...
        // Verify values
        await expect(this.page.getByRole('gridcell', { name: 'Adjustment' })).toBeVisible();
