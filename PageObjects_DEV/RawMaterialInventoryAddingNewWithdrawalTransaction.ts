...
import { AddingWithdrawalRawMaterialInventory } from "../TestData_Dev/RawMaterialInventoryWithdrawalAddingJData";


    export class RawMaterialInventoryAddingNewWithdrawalTransaction {
        public page : Page;
        ...
        async performAddingNewWithdrawalTransaction()
        {
          ...
          await this.page.getByLabel('Lot Number: *').fill(AddingWithdrawalRawMaterialInventory.LOTNUmber);
          console.log(AddingWithdrawalRawMaterialInventory.LOTNUmber);

          //Selecting Transaction type
          await this.page.getByPlaceholder('Select a transaction code').click();
          await this.page.getByText(AddingWithdrawalRawMaterialInventory.TransactionCode).click();
          console.log(AddingWithdrawalRawMaterialInventory.TransactionCode);

          //Selecting Unit of issue 
          await this.page.getByPlaceholder('Select a unit of issue').click();
          await this.page.getByLabel('Items').getByText(AddingWithdrawalRawMaterialInventory.UnitOfIssueID).click();
          console.log(AddingWithdrawalRawMaterialInventory.UnitOfIssueID)
          ...
          await this.page.getByLabel('Operator Name:').fill(AddingWithdrawalRawMaterialInventory.OperatorName);
          await this.page.getByLabel('Keyed By:').click();
          await this.page.getByLabel('Keyed By:').fill(AddingWithdrawalRawMaterialInventory.KeyedBy);
          await this.page.getByLabel('Note:').click();
          await this.page.getByLabel('Note:').fill(AddingWithdrawalRawMaterialInventory.Note);
          ...
          await this.page.screenshot({ path: `Screenshots_DEV/2(Withdrawal).png`});
